...
class BlogImgZoom extends StatefulWidget {
  String? imageIndex;

  BlogImgZoom({super.key, required this.imageIndex});

  @override
  State<BlogImgZoom> createState() => _BlogImgZoomState();
}

class _BlogImgZoomState extends State<BlogImgZoom> {
