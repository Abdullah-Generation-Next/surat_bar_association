...
class EventImgZoom extends StatefulWidget {
  String? imageIndex;

  EventImgZoom({super.key, required this.imageIndex});

  @override
  State<EventImgZoom> createState() => _EventImgZoomState();
}

class _EventImgZoomState extends State<EventImgZoom> {
