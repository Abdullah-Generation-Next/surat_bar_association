...
class ParticipationImgZoom extends StatefulWidget {
  String? imageIndex;

  ParticipationImgZoom({super.key, required this.imageIndex});

  @override
  State<ParticipationImgZoom> createState() => _ParticipationImgZoomState();
}

class _ParticipationImgZoomState extends State<ParticipationImgZoom> {
