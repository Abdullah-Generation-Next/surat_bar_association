...
import 'achievement_tile_detail.dart';

class AchievementTileScreen extends StatefulWidget {
  const AchievementTileScreen({super.key});

  @override
  State<AchievementTileScreen> createState() => _AchievementTileScreenState();
}

class _AchievementTileScreenState extends State<AchievementTileScreen> {
  ...
  List<achievementDatum?> data = [];

  Future<void> fetchDataFromAPI(id) async {
    Map<String, dynamic> parameter = {
      "user_id": id,
    };
    await achievementData(parameter: parameter).then((value) {
      setState(() {
        data = value.data;
      });
      // print(value);
                    ...
                    child: ListTile(
                      ...
                      title: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5,),
                          Text("Month: ${data[index]!.monthDigit} " " ${data[index]!.monthText}",textScaleFactor: 0.9,),
                          SizedBox(height: 5,),
